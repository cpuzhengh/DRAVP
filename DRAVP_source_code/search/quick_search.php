...
<div class="container" style="padding-bottom:100px;">
    ...
    <div class="row mt40" style="padding-top: 20px">
        ...
        <table class="table table-bordered">
            ...
            $sq="select * from Public_peptides  where  (Sequence like '%$tcont%' or Name like '%$tcont%' or Target_organism like '%$tcont%' or DRAVP_ID like '%$tcont%')  order by DRAVP_ID asc";
            ...
            $sqld="select * from Public_peptides where  (Sequence like '%$tcont%' or Name like '%$tcont%' or Target_organism like '%$tcont%' or DRAVP_ID like '%$tcont%') order by DRAVP_ID asc limit $start,$pagesize";
...
<div class="container mt-5">
    ...
    <div class="text-right mb-5">
        ...
        echo ' <a href="quick_search.php?page=1&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default">First</a> ';
        ...
        if($pagecount>$showpages){
            ...
            for($i=$start;$i<=$end;$i++){
                if($i==$page){
                    echo ' <a href="quick_search.php?page='.$i.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-primary">'.$i.'</a> ';
                }else{
                    echo ' <a href="quick_search.php?page='.$i.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default" >'.$i.'</a> ';
                }
            }
        }else{
            for($i=$start;$i<=$end;$i++) {
        ...
        echo ' <a href="quick_search.php?page='.$pagecount.'&slt='.$tit.'&txtarea='.$tcont.'" class="btn btn-default">Last</a> ';
